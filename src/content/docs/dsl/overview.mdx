...
query 2users `...`       // Invalid - starts with digit
```
...
The scope name must exactly match a defined query name.
...
QueryName {
  // Scope level - runs for this query scope
  setup `...`
