...
Use `assert { }` with one or more expressions:
...
<Aside type="tip">
  Multiple expressions are separated by semicolons. All must pass for the test to pass.
</Aside>
...
5. **Prefer named queries** — Reusable and more readable than inline queries
